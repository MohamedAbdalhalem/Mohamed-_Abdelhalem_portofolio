...
const projects: Project[] = [
  {
    ...
    description:
      "E-Commerce Web Application that delivers a full online shopping experience.",
  ...
  },
  {
    ...
    image: LUMIÈREImg,
    description:
      "The LUMIÈRE platform allows users to browse skincare products",
    features: [
      "User Authentication",
      "Personalized Skin Survey",
  ...
  },
  {
    ...
    description:
      "E-Commerce Web App with secure auth and multiple payment methods.",
  ...
  },
  {
    ...
    description:
      "Notes app with full CRUD functionality and user authentication.",
